...
public:
    ...
    const std::vector<std::shared_ptr<Plan>>& children() const { return children_; }
...
// class plannerInfo{
//     public:
//     std::shared_ptr<ast::SelectNode> parse;
//     std::vector<Condition> where_conds;
//     std::vector<TabCol> sel_cols;
//     std::shared_ptr<Plan> plan;
//     std::vector<std::shared_ptr<Plan>> table_scan_executors;
//     std::vector<SetClause> set_clauses;
//     plannerInfo(std::shared_ptr<ast::SelectNode> parse_):parse(std::move(parse_)){}
