...
std::shared_ptr<IStmt> Planner::logical_optimization(std::shared_ptr<IStmt> query, Context *context)
{
...
std::shared_ptr<Plan> Planner::physical_optimization(std::shared_ptr<IStmt> query, Context *context)
{
 ...
 * 没考虑joinTree
 */
std::shared_ptr<Plan> Planner::make_one_rel(std::shared_ptr<IStmt> stmt)
{
 ...
 */
std::shared_ptr<Plan> Planner::generate_select_plan(std::shared_ptr<IStmt> query, Context *context) {
    // //逻辑优化
...
std::shared_ptr<Plan> Planner::do_planner(std::shared_ptr<IStmt> stmt, Context *context)
{
    ...
    // } else if (auto x = std::dynamic_pointer_cast<ast::InsertNode>(query->parse)) {
    //     // insert;
    ...
    // } else if (auto x = std::dynamic_pointer_cast<ast::DeleteNode>(query->parse)) {
    //     // delete;
    //     // 生成表扫描方式
    ...
    // } else if (auto x = std::dynamic_pointer_cast<ast::UpdateNode>(query->parse)) {
    //     // update;
    //     // 生成表扫描方式
    //     std::shared_ptr<Plan> table_scan_executors;
    //     // 只有一张表，不需要进行物理优化了
    ...
    //                                                  query->set_clauses);
    // } else if (auto x = std::dynamic_pointer_cast<ast::SelectNode>(query->parse)) {
