...
#define DEFINE_RCS                       \
  ...
  DEFINE_RC(SCHEMA_TABLE_NAME_MISSING)   \
  DEFINE_RC(SCHEMA_ALIAS_NAME_MISSING)   \
  DEFINE_RC(DUPLICATE_ALIAS_NAME)        \
...
extern bool RM_SUCC(RC rc);
extern bool RM_FAIL(RC rc);