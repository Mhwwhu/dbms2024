...
public:
	 ...
	 */
	virtual RC to_string(const Value& val, std::string& result) const { return RC::UNSUPPORTED; }
	...
	virtual RC set_value_from_str(Value& val, const std::string& data) const { return RC::UNSUPPORTED; }
